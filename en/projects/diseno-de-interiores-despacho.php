<?php 
$title="Lisboa | Diseño de interiores, despacho";
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="cont-text">
					<h2>DESPACHO</h2>
					<h1>Diseño de interiores, despacho</h1>
					<p>En este proyecto nos solicitaron crear un espacio de trabajo acogedor y reconfortante que fuera clásico y actual aumentando la iluminación artificial. El audaz uso de color, las luminarias y las cortinas fueron parte esencial del diseño para la transformación del lugar. Cada detalle decorativo contribuye a la percepción integral del sitio.</p>
				</div>
			</div>
		</div>
	</div>
