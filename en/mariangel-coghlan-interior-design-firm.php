	...
	<div id="index-slider" class="single-index slider clientes is-clearfix top-img index" style="padding-bottom:0px; position: relative; margin-bottom: 0">
					...
					<div class="service-icon-box">
						...
						<div class="center-box">
							...
							<div>
								<a class="btn-slider" href="/diseno-de-interiores-casas">learn more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-icon-box">
						...
						<div class="center-box">
							...
							<div>
								<a class="btn-slider" href="/diseno-interior#oficinas">learn more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-icon-box">
						...
						<div class="center-box">
							...
							<div>
								<a class="btn-slider" href="/diseno-de-interiores-comercial">learn more</a>
							</div>
						</div>
					</div>
					...
					<div class="service-icon-box">
						...
						<div class="center-box">
							...
							<div>
								<a class="btn-slider" href="/galeria/diseno-de-amenidades">learn more</a>
							</div>
						</div>
					</div>
					<div class="service-icon-box">
						...
						<div class="center-box">
							...
							<div>
								<a class="btn-slider" href="/diseno-arquitectonico">learn more</a>
							</div>
						</div>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 title">
				...
				<div class="cont-text">
					<div class="h1-cont">
						<h1>We are a Mexican interior design firm</h1>
						<span>that specializes in reinventing spaces and creating unique experiences.</span>
					</div>
					<p>Your project’s size doesn’t matter; from a sofa, bedroom, to an entire restaurant or hotel. We take care of every detail with a comprehensive approach, leaving the living space ready to be enjoyed.</p>
					<p>Many of our firm’s projects have been published in several countries around the globe through the Homify portal.</p>
					<h3>Our firm has been awarded Best Luxury Interior Design Studio in Mexico by Luxury Awards and is considered among the 20 must-follow designers in 2021 according to Entrepreneurs Herald</h3>
