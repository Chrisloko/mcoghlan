		...
		<div class="row">
			...
			<div class="item-3">
				<a class="venobox" data-autoplay="true" data-vbtype="video" href="https://youtu.be/ExCu4A6Ou4A">
					<div class="img-cont servicios">
						<img class="" alt="Servicios Mariangel Coghlan" src="img/servicios/videoUP-serviciosremod.jpg" onmouseover="this.src='img/servicios/videoHOVER-serviciosremod.jpg'" onmouseout="this.src='img/servicios/videoUP-serviciosremod.jpg'" >
					</div>
				</a>	
			</div>
			<div class="item-3">
				<a class="venobox" data-autoplay="true" data-vbtype="video" href="https://youtu.be/gipQwFLfl4g">
					<div class="img-cont servicios">
						<img class="" alt="Servicios Mariangel Coghlan" src="img/servicios/antesydepuesUP-servicios-remodelacion.jpg" onmouseover="this.src='img/servicios/antesydepuesOVER-servicios-remodelacion-1.jpg'" onmouseout="this.src='img/servicios/antesydepuesUP-servicios-remodelacion.jpg'" >
					</div>
				</a>	
			</div>
		</div>
